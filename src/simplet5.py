...
class PyLightningDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage=None):
        self.train_dataset = PyDataModule(
            self.train_df,
            self.tokenizer,
            self.source_max_token_len,
            self.target_max_token_len,
        )
        self.test_dataset = PyDataModule(
            self.test_df,
            self.tokenizer,
            self.source_max_token_len,
            self.target_max_token_len,
...
class PyLightningModel(pl.LightningModule):
    ...
    def training_epoch_end(self, training_step_outputs):
        ...
        path = f"{self.outputdir}/simplet5-epoch-{self.current_epoch}-train-loss"
...
class SimpleT5:
    ...
    def train(
        ...
        """
        self.target_max_token_len = target_max_token_len
        self.data_module = PyLightningDataModule(
            train_df,
            eval_df,
            self.tokenizer,
